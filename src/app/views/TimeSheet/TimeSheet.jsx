...
class Category extends React.Component {
  ...
  renderDataMappingDate = () => {
    ...
    for (let index = 1; index <= daysInMonth; index++) {
      let day = {};
      day.date = moment(new Date(date.getFullYear(), date.getMonth(), index))
        .format("DD-MM-yyyy")
        .toString();
      day.name_day =
        days[new Date(date.getFullYear(), date.getMonth(), index).getDay()];
  ...
  render() {
    ...
    let { keyword, shouldOpenNotificationPopup, project, percentWork } =
      this.state;
      ...
      { title: "Thứ", field: "name_day", align: "left", width: "8%" },
      {
        ...
        render: (rowData) => (
          <Autocomplete
            ...
            // }}
            renderInput={(params) => (
              <TextField {...params} label="Dự án" variant="outlined" />
            )}
          />
        ),
      },
      {
        title: "Phần trăm nỗ lực 1",
        field: "Dus",
        align: "left",
        width: "10%",
        render: (rowData) => (
          <Autocomplete
            ...
            // }}
            renderInput={(params) => (
              <TextField {...params} label="Phần trăm" variant="outlined" />
            )}
          />
        ),
      },
